...
namespace POLA_MMS.UI_Subject
{
    public partial class frmSubject : Form
    {
        ...
        private void frmSubject_Load(object sender, EventArgs e)
        {
            ...
            {
                Subject objSub = new SubjectManager().Select(this.m_iSubjectId);
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (this.m_iSubjectId > 0)
            {
                ...
                objSubMan.UpdateSubject(objSub);
            }
            else
            {
                if (iTempId > 0)
                ...
                objSubMan.InsertSubject(objSub);
            }
