...
namespace POLA_MMS.UI_Employee
{
    public partial class frmEmployee : Form
    {
        ...
        private void frmEmployee_Load(object sender, EventArgs e)
        {
            ...
            if (this.m_iEmpId > 0)
            {
                Employee objEmp = new EmployeeManager().SelectList(this.m_iEmpId);
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            EmployeeManager objEmpM = new EmployeeManager();
            ...
            int iTempId = objEmpM.ExistsEmployeeCode(objEmp.Code);
            if (this.m_iEmpId > 0)
            {
                //更新数据
        ...
        private void cboPost_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.m_strDoPost == "NewAdd" && this.m_bRun)
            {
                ...
                Post objPost = new PostManager().SelectList(iPostId);
