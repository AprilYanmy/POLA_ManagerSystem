...
namespace POLA_MMS.UI_Employee
{
    public partial class frmEmployee_Money : Form
    {
        ...
        private void LoadEmployeeMoneyList()
        {
            ...
            List<EmpMoney> lstEmpMoney = new EmpMoneyManager().SelectList(this._iEmpId, iYear, iMonth);
        ...
        {
            Common.ShowRows_DataGridView_RowPostPaint(this.dgvEmpMoney, sender, e);
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (this.dgvEmpMoney.CurrentRow != null)
            {
                ...
                if (new EmpMoneyManager().Delete(dId) > 0)
                {
                    this.LoadEmployeeMoneyList();
                }
            }
