...
namespace POLA_MMS.Report_UI
{
    public partial class frmDeposit : WinFormsUI.Docking.DockContent
    {
        ...
        {
            List<Deposit> lstDeposit = new DepositManager().SelectList("", this.cboDate.Year, this.cboDate.Month, this.cboDate.Day);
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            PrintDataGridView.Print(dgvDeposit, "统计报表", Properties.Resources.system);
